...
public class KakaoCategorySearchService {
    ...
    // DocumentDto 에서 자료를 뽑아 길찾기, 로드맵을 추가
    private OutputDto convertDto(DocumentDto documentDto) {
        // 로드뷰 URL 만들기
        // https://map.kakao.com/link/roadview/127.026692446306,37.4987750083767
        String ROAD_VIEW_URL = "https://map.kakao.com/link/roadview/";
        // 길찾기 URL 만들기
        // https://map.kakao.com/link/to/강남엘 약국/127.026692446306,37.4987750083767
        ...
        String mapUrl = UriComponentsBuilder
                .fromUriString(DIRECTION_URL + params).toUriString();
        ...
        return OutputDto.builder()
                ...
                .pharmacyAddress(documentDto.getAddress_name())
                .directionURL(mapUrl)
                .roadViewURL(roadUrl)
